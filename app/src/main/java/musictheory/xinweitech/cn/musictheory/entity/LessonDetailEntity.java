...
public class LessonDetailEntity implements Serializable {
    ...
    /**
     * err : 0
     * data : {"lessonId":1,"title":"五线谱、谱号和附加线","list":[{"content":"五线谱的每一行..","type":0,"audioUrls":"http:127.0.0.1/a-1.mp3"},{"content":"五线谱的每一行..","type":0},{"content":"http://127.0.0.1/img.png","type":1}]}
     */

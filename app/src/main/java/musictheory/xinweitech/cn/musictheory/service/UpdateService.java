                ...
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), getApkName(downloadUrl)) {
                    ...
                    public void inProgress(float progress, long total, int id) {
                        ...
                        if (nowProgress >= 100) {
                            ...
                            mBuilder.setContentTitle(getResources().getString(R.string.download_complete_click_install));
                            stopSelf(); //停止服务
                            ...
                            if (nowProgress % 10 == 0) {
                                ...
                                mBuilder.setContentTitle(getResources().getString(R.string.download_is_in_progress));
...
//                .setContentTitle("开始下载...")     //设置通知栏标题
                .setTicker(getResources().getString(R.string.start_download))

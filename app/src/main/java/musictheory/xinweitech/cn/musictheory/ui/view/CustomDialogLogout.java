...
public class CustomDialogLogout extends Dialog {
    ...
    private Button no;//确定按钮
    private TextView titleTv;//消息标题文本
    private TextView title_out;//消息标题文本
    ...
    private void initView() {
        ...
        no = (Button) findViewById(R.id.bt_no);
        title_out = (TextView) findViewById(R.id.title_out);
    }

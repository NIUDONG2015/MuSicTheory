package musictheory.xinweitech.cn.musictheory.update;
...
/**
 * Created by niudong on 2016-1-16.
 */
public class UpdateDownLoadRequest implements Runnable {
    ...
    public UpdateDownLoadRequest(Context context, String downLoadUrl, String localFilePath, UpdateDownLoadListener listener) {
        ...
        try {
            if (!Thread.currentThread().isInterrupted()) {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    mDownLoadHandler.sendFailureMessage(mContext.getResources().getString(R.string.internet_conn_erro));
                }
    ...
    public class DownLoadResponseHandler {
        ...
        public void sendResponseMessage(InputStream inputStream) {
            ...
            try {
                ...
                e.printStackTrace();
                sendFailureMessage(mContext.getResources().getString(R.string.io_stream_exception));
            } finally {
                try {
                    if (inputStream != null)
                        inputStream.close();
